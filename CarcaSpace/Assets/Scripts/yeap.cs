...
// public class yeap : NetworkBehaviour
// {
...
//     public List<GameObject> lstCar = new List<GameObject>();
...
//         // cette information va dire si une structure (suite de tuile connecté les un autres formant un chemin) est clos
//         // initialement c'est faux.
...
//     // cette fonction défini une structure comme étant clos
//     // void setStructToClosed(CurrentRoads curRds)
//     // {
//     //     curRds.isClosed = true;
//     // }

//     // cette fonction met à jour si une struct (chemin) est clos.
//     // void updateClosing(CurrentRoads curRds)
//     // {
//     //     // il y a que deux possiblités. Que quelqu'un me dise le contraire :p !
//     //     // case one:  le chemin contient deux tuiles fermantes
//     //     // case two: le chemin forme une boucle.
//     //     int nbCheminFermant = 0;

//     //     if(curRds.isClosed == false)
//     //     {
//     //         // parcourir la liste des tuiles connectés
//     //         foreach(GameObject tiles in curRds.CurrentTiles)
//     //         {
//     //             if(tiles.GetComponent<Constraints>().estCheminFermant == true)
//     //             {
//     //                 nbCheminFermant ++;
//     //             }
//     //         }
//     //         if(nbCheminFermant == 2)
//     //         {
//     //             setStructToClosed(curRds);
//     //         }
//     //     }

//     //     // le deuxième cas sera traité directement dans la fonction roadIsClosed_struct
//     //     // dès qu'on détectera une fermeture sur soie même (une boucle)
//     //     return;
//     // }
...
//     //     {
//     //         CurrentRoads essaie = new CurrentRoads("essaie", tile_laid);

//     //         // essaie.isClosed = true;
//     //         list_of_struct_roads.Add(essaie);
//     //     }
//     public void roadIsClosed_Struct(GameObject tile_laid)
//     {
...
//                 // indiquer qu'il est clos :)
//                 // setStructToClosed(road);
//                 road.isClosed = true;
//                 Debug.Log("fermé gauche <-> haut" + " dans " + road.Name + "& close? : "+ road.isClosed);
...
//                 // peut être que notre tuile a fuisionner deux chemin formant "road_haut" et qui possède maintenant 2 tuiles fermantes
//                 // Si oui, il faut mettre à jour la fermeture 
//                 // updateClosing(road_haut);

//                 /* - --------- Algo de détection de chemin clos dans le cas des carrefour --------- */
//                 // stocker s'il y en a , les carrefours dans la liste <lstcar>.
//                 // for(int i = 0; i < road_gauche.CurrentTiles.Count; i++)
//                 // {
//                 //     if(road_gauche.CurrentTiles[i].GetComponent<Constraints>().carrefour == true)
//                 //     {
//                 //         lstCar.Add(road_gauche.CurrentTiles[i]);
//                 //     }
//                 // }

//                 // for(int i = 0; i < road_haut.CurrentTiles.Count; i++)
//                 // {
//                 //     if (road_haut.CurrentTiles[i].GetComponent<Constraints>().carrefour == true)
//                 //     {
//                 //         lstCar.Add(road_gauche.CurrentTiles[i]);
//                 //     }
//                 // }
...
//                 // {
//                 //    if(road_gauche.CurrentTiles.Contains(lstCar[i]) && road_haut.CurrentTiles.Contains(lstCar[i]))
//                 //    {
//                 //        count++;
//                 //    }
//                 // }
...
//                 nb_of_struct_roads--;
//                 // if(count == lstCar.Count)
//                 //     road_haut.Status = true;
//                 // // réinitialiser la liste des carrefours pour être safe.
//                 // lstCar.Clear();
//             }
...
//                 //setStructToClosed(road);
//                 road.isClosed = true;
//                 Debug.Log("fermé gauche <-> bas" + road.Name + "close? : "+ road.isClosed);
//                 //calcul de points + destruction de la structure                
//             }
...
//                 // peut être que notre tuile a fuisionner deux chemin formant "road_bas" et qui possède maintenant 2 tuiles fermantes
//                 // Si oui, il faut mettre à jour la fermeture 
//                 // updateClosing(road_bas);
//                 list_of_struct_roads.Remove(road_gauche);
//                 nb_of_struct_roads--;
//             }
...
//                 //setStructToClosed(road);
//                 road.isClosed = true;
//                 Debug.Log("fermé gauche <-> droite" + road.Name + "close? "+ road.isClosed);
//                 //calcul de points + destruction de la structure                
//             }
//             if(nom_struct_gauche != nom_struct_droite && nom_struct_bas == "" && nom_struct_haut == "")
//             {
...
//                 // peut être que notre tuile a fuisionner deux chemin formant "road_droite" et qui possède maintenant 2 tuiles fermantes
//                 // Si oui, il faut mettre à jour la fermeture 
//                 // updateClosing(road_droite);
//                 list_of_struct_roads.Remove(road_gauche);
//                 nb_of_struct_roads--;
//             }
...
//                 //setStructToClosed(road);
//                 road.isClosed = true;
//                 Debug.Log("fermé droite <-> haut<" + road.Name + "> close? "+ road.isClosed);
//                 //calcul de points + destruction de la structure                
//             }
//             if(nom_struct_droite != nom_struct_haut && nom_struct_bas == "" && nom_struct_gauche == "")
//             {
...
//                 //setStructToClosed(road);
//                 road.isClosed = true;
//                 Debug.Log("fermé droite <-> bas <" + road.Name + "> close? "+ road.isClosed);
//                 //calcul de points + destruction de la structure                
//             }
//             if(nom_struct_droite != nom_struct_bas && nom_struct_haut == "" && nom_struct_gauche == "")
//             {
...
//                 road.CurrentTiles.Add(tile_laid);
//                 // indiquer qu'il est clos. c'est évident :)
//                 //setStructToClosed(road);
//                 road.isClosed = true;
//                 Debug.Log("fermé haut <-> bas" + road.Name + "close? "+ road.isClosed);
//                 //calcul de points + destruction de la structure                
//             }
//             if(nom_struct_haut != nom_struct_bas && nom_struct_gauche == "" && nom_struct_droite == "")
//             {
...
//         //         // mettre à jour si possible la fermeture: notre tuile pourrais être une tuile fermante
//         //         // updateClosing(cr);
