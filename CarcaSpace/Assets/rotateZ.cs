...
// Script pour rotate la tuile
public class rotateZ : MonoBehaviour {
  public float speed; // vitesse de rotation de la tuile
  // booléens qui lance les animations
  public bool leve = false;
  public bool tourne = false;
  public bool couche = false;
  internal float angle = 0.0f; // angle qui de rotation actuel de la tuile
  private float angle_last;    // ancien angle
  ...
  void Update() {
    ...
    if (leve) {
      ...
      transform.rotation =
          Quaternion.Slerp(transform.rotation, target, speed * Time.deltaTime);
    }
